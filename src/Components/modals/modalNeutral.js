...
import neutralFace from '../../../assets/neutFace.png'



const ModalNeutral = ({ visible, onClose }) => {
        ...
        >
          <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
              <Text style={styles.messageText}>No se encontraron datos</Text>
              <Image source={neutralFace} style={styles.imagen} resizeMode="contain" />
